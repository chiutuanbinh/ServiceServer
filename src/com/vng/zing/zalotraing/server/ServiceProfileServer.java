...
public class ServiceProfileServer {
    ...
    public static AtomicLong totalGetTime = new AtomicLong(1);
    public static AtomicLong totalSetTime = new AtomicLong(1);
    public static AtomicLong totalRemoveTime = new AtomicLong(1);
    public static AtomicLong getReq = new AtomicLong(0);
    public static AtomicLong setReq = new AtomicLong(0);
    public static AtomicLong removeReq = new AtomicLong(0);
    public static AtomicLong lastGetTime = new AtomicLong(0);
    public static AtomicLong lastSetTime = new AtomicLong(0);
    public static AtomicLong lastRemoveTime = new AtomicLong(0);
