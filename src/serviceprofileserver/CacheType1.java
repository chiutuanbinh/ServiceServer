 ...
 * @author root
 */
public final class CacheType1 implements CacheIface{
    ...
    private static final CacheType1 INSTANCE = new CacheType1();
    ...
    public static synchronized CacheType1 getInstance(){
        return INSTANCE;
    }
